...
module.exports = class Ping extends Command {
  ...
  async run(message, args) {
    ...
    if(this.client.utils.permissionsLength(message, member, config.general.review_req.permissions) > 0 || !this.client.utils.hasRole(this.client, message, config.general.review_req.roles, true)) return message.channel.send({ embeds: [this.client.embedBuilder(this.client, message.author, this.client.embeds.title, this.client.language.service.reviews.cannot_review, this.client.embeds.error_color)] });
  ...
  async slashRun(interaction, args) {
    ...
    if(this.client.utils.permissionsLength(interaction, member, config.general.review_req.permissions) > 0 || !this.client.utils.hasRole(this.client, interaction, config.general.review_req.roles, true)) return interaction.reply({ embeds: [this.client.embedBuilder(this.client, interaction.user, this.client.embeds.title, this.client.language.service.reviews.cannot_review, this.client.embeds.error_color)] });
